...
class GPSNode(Node):
    def __init__(self):
        ...
        timer_period = 0.1  # Segundos entre publicaciones 0.1
    ...
    def publish_gps_data(self, lat, lon, alt):
        ...
        # Para precisión de 1 cm (comentar si usas la de 1 metro)
        # precision_cm = 0.01
        # msg.position_covariance = [
        #     precision_cm**2, 0.0, 0.0,
        #     0.0, precision_cm**2, 0.0,
        #     0.0, 0.0, precision_cm**2
        # ]
