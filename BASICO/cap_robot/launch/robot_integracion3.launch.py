...
def generate_launch_description():
    ...
    rviz_config_dir = os.path.join(get_package_share_directory('cap_robot'), 'rviz', 'robot2.rviz')

    # Ruta a los archivos de configuración YAML para EKF y navsat_transform
    ekf_config_path = os.path.join(get_package_share_directory("cap_robot"), 'config', 'ekf_gps_imu2.yaml')
    navsat_config_path = os.path.join(get_package_share_directory("cap_robot"), 'config', 'gps_navsat2.yaml')
    ...
    return LaunchDescription([
        ...
        # Nodo rqt_graph para visualizar el grafica de nodos
        Node(
            package='rqt_graph', 
        ...
        # Ejecutable del rviz2 para visualizar el movimiento 
        Node(
            package='rviz2',
            executable='rviz2',
            name='rviz2',
