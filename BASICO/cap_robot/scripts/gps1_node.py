...
class GPSNode(Node):
    def __init__(self):
        ...
        # Punto de referencia inicial (ajusta según tu ubicación)
        self.lat0 = 0.0  # Latitud inicial
        self.lon0 = 0.0  # Longitud inicial
    ...
    def publish_gps_data(self, lat, lon, alt):
        ...
        msg.header.frame_id = 'map' # debido a que el gps nos proporciona una posicion absoluta 
        msg.latitude = lat
        msg.longitude = lon
        msg.altitude = alt

        # Establecer la covarianza estimada para precisión de 1 metro
        ...
        # Publicar el mensaje de datos GPS
        ...
        # Crear y publicar el mensaje de coordenadas cartesianas
        cartesian_msg = Point()
        cartesian_msg.x = x
        cartesian_msg.y = y
        cartesian_msg.z = alt  # Usar altitud como coordenada z

        self.cartesian_publisher_.publish(cartesian_msg)

        # Mostrar solo los datos necesarios en la consola
